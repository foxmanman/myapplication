 ...
 * 邮箱：429883793@qq.com
 * material design listview
 *
 */

public class CustomListView extends ListView implements OnScrollListener {

	String pull_text = "下拉刷新";
	String end_loadmore = "点击加载更多";

	public void setPullText(String text) {
		pull_text = text;
	}

	public void setEndloadmore(String text) {
		end_loadmore = text;
		mEndLoadTipsTextView.setText(text);
	}
	...
	private CircularProgressBar mEndLoadProgressBar;
	...
	private void init(Context pContext) {
		setCacheColorHint(pContext.getResources().getColor(R.color.all9));
	...
	private void addHeadView() {
		...
		LinearLayout head_linetest = (LinearLayout) mHeadView
				.findViewById(R.id.head_linetest);
	...
	private void addFooterView() {
		...
		mEndLoadProgressBar = (CircularProgressBar) mEndRootView
				.findViewById(R.id.pull_to_refresh_progress);
		mEndLoadTipsTextView = (TextView) mEndRootView
				.findViewById(R.id.load_more);
		// TODO changgbyWgy
		mEndLoadTipsTextView.setText(end_loadmore);
	...
	// TODO
	public interface CustomScroListener {
		void onCustomScroll(AbsListView pView, int pFirstVisibleItem,
							int pVisibleItemCount, int pTotalItemCount);

		void onCustomScrollStateChanged(AbsListView pView, int pScrollState);
	}

	private CustomScroListener customScroListener = null;

	public void setCustomScroListener(CustomScroListener customscroListener) {
		customScroListener = customscroListener;
	}
	...
	public void onScroll(AbsListView pView, int pFirstVisibleItem,
		...
		// addforXingquanBlog
		if (customScroListener != null) {
			customScroListener.onCustomScroll(pView, pFirstVisibleItem,
	...
	public void onScrollStateChanged(AbsListView pView, int pScrollState) {
		...
		// addforxingquanblog
		if (customScroListener != null)
			customScroListener.onCustomScrollStateChanged(pView, pScrollState);
	}
	...
	// TODO add for xingquan chat

	public boolean ischat;

	public void setisChat(boolean b) {
		this.ischat = b;
	}
	...
	private void changeHeaderViewByState() {
		...
		case PULL_TO_REFRESH:
			...
			if (mIsBack) {
				...
				// 下拉刷新
				mTipsTextView.setText(pull_text);
			} else {
				// 下拉刷新
				mTipsTextView.setText(pull_text);
			}
